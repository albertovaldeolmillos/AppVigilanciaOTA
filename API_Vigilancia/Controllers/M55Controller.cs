...
{
    public class M55Controller : ApiController
    {
        private readonly System.Resources.ResourceManager resourceManagerAPIVigilancia = new ResourceManager(typeof(Resources));

        [System.Web.Http.Route("M55")]
        public IHttpActionResult GetM55()
        {
            M55.ResponseDTO resultDTO = new M55.ResponseDTO();
            try
            {
                TextReader sr = new StringReader(new M55().Process()[0]);
...
//#endif
        ...
        public List<Object> GetDTO(XElement xmlTree)
        {
            ...
            if (xmlTree.Elements().Any())
            {
                ...
                xmlTree.Elements().ToList().ForEach(o => lObjDTO.Add(new M55.M55DTO()
                {
