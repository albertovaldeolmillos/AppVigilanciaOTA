...
namespace PDMCompute
{
    ...
    public class CDatM1 : CDatM
    {
        ...
        public bool GetOutHistPostPay()
        {
            return m_bOutHistPostPay;
        }
        ...
        public bool GetCurrentAmountIsAllowed()
        {
            return m_bCurrentAmountIsAllowed;
        }
        ...
        public long GetOutAddFreeMoneyQuantity()
        {
            return m_lOutAddFreeMoneyQuantity;
        }

        public long GetOutAddFreeMinutesQuantity()
        {
            return m_lOutAddFreeMinutesQuantity;
        }

        public bool GetOutHistFreeMoneyUsed()
        {
            return m_bHistFreeMoneyUsed;
        }
